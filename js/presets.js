...
const BUILT_IN_PRESETS = [
  ...
  },
  {
    ...
    durationMs: null,
    periods: 1,
    rulesKey: 'zahlenecken',
    categories: ['lauf'],
    builtIn: true,
  },
  {
    id: 'builtin-krankenhausfangen',
    ...
    durationMs: null,
    periods: 1,
    rulesKey: 'krankenhausfangen',
    categories: ['lauf'],
    builtIn: true,
  },
  {
    id: 'builtin-linienfangen',
    name: 'Linienfangen',
    icon: '📏',
    teamA: { name: 'Fänger' },
    teamB: { name: 'Läufer' },
    ...
    durationMs: null,
    periods: 1,
    rulesKey: 'linienfangen',
    categories: ['lauf'],
    builtIn: true,
  },
  {
    id: 'builtin-versteinern',
    name: 'Versteinern',
    icon: '🗿',
    teamA: { name: 'Fänger' },
    teamB: { name: 'Läufer' },
    ...
    durationMs: null,
    periods: 1,
    rulesKey: 'versteinern',
    categories: ['lauf'],
    builtIn: true,
  },
  {
    id: 'builtin-kettenfangen',
    name: 'Kettenfangen',
    icon: '⛓️',
    teamA: { name: 'Kette' },
    teamB: { name: 'Läufer' },
    ...
    durationMs: null,
    periods: 1,
    rulesKey: 'kettenfangen',
    categories: ['lauf', 'team'],
    builtIn: true,
  },
  {
    id: 'builtin-feuerwassersturm',
